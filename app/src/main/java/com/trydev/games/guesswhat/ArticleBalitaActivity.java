...
public class ArticleBalitaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseAccess.open();
        String[] daftarTitle = databaseAccess.getTitleBalita();
        String[] daftarDeskripsi = databaseAccess.getDescBalita();
...
class MyBalitaAdapter extends ArrayAdapter{
int[]imageArray;
String [] titleArray;
String[]descArray;

public MyBalitaAdapter(Context context, String []titles1, String[] descriptions1, int[] img1){
